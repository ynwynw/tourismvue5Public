<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"width":"100%","padding":"10px 15px","borderColor":"#d8dce5","overflow":"hidden!important","background":"#EEEEEE","height":"auto"}'>
		<scroll-pane ref="scrollPane" class="tags-view-wrapper">
			<div class="tags-view-box" :style='{"width":"100%","padding":"0 20px","overflow":"hidden!important","background":"#fff"}'>
