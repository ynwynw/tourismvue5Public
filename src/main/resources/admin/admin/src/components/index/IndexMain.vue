<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 6px  rgb(0,0,0,.3)","padding":"8px 150px 8px 0","alignItems":"center","display":"flex","width":"100%","position":"relative","justifyContent":"flex-end","zIndex":"999","height":"60px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"width":"100%","padding":"20px 15px","borderColor":"#eee","borderStyle":"solid","borderWidth":"0 0 1px 0","background":"#EEEEEE"}' class="bread-crumbs"></bread-crumbs>
