	...
	<div class="list" :style='{"width":"70%","margin":"0 auto 20px","background":"#fff","flex":"1","order":"4"}'>
		...
		<div class="list2 index-pv1" :style='{"padding":"0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"padding":"25px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"10px 0","background":"#fff","display":"flex","width":"calc(50% - 10px)","fontSize":"0","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<div :style='{"border":"0","width":"150px","padding":"0","height":"110px"}'>
					<img @click.stop="imgPreView(item.touxiang)" :style='{"border":"1px solid #eee","width":"100%","objectFit":"contain","background":"#fff","display":"block","height":"100%"}' v-if="item.touxiang && item.touxiang.substr(0,4)=='http'" :src="item.touxiang.split(',')[0]" class="image" />
					<img @click.stop="imgPreView(baseUrl + (item.touxiang?item.touxiang.split(',')[0]:''))" :style='{"border":"1px solid #eee","width":"100%","objectFit":"contain","background":"#fff","display":"block","height":"100%"}' v-else :src="baseUrl + (item.touxiang?item.touxiang.split(',')[0]:'')" class="image" />
				</div>
				<div class="item-info" :style='{"padding":"10px","overflow":"hidden","alignItems":"center","flexWrap":"wrap","flex":"1","display":"flex","height":"auto"}'>
					<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"50%","lineHeight":"1","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"bold","order":"1"}' class="name ">{{item.yonghuzhanghao}}</div>
					<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"50%","lineHeight":"1","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"bold","order":"1"}' class="name ">{{item.yonghuxingming}}</div>
